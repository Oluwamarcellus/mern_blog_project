  ...
  return (
    <div className="px-4 py-10">
      <div className="pt-10 min-h-screen w-full max-w-[800px] mx-auto">
        ...
        <p className="text-center pb-6 text-base text-black/ dark:text-gray-300">
      ...
      <div className="mt-6 border bg-black/10 rounded-lg">
        <h2 className="text-center py-2 italic text-black/40 dark:text-gray-200">Follow me@</h2>
        <div className="flex justify-center gap-5 mb-3">
          ...
          <a href="https://github.com/Oluwamarcellus" target="_blank" className="text-xl cursor-pointer text-black/70 dark:text-gray-300"><FaGithub /></a>
        </div>
      </div>
    </div>
  );
