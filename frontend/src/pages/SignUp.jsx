  ...
  return (
    <div className="py-24 px-4 flex flex-col md:flex-row gap-8 md:items-center mx-auto w-full max-w-3xl">
      ...
      <div className="md:flex-1">
        ...
        <button type="button" className="flex justify-center items-center gap-3 border-2 border-purple-500/50 rounded-xl px-3 py-2 cursor-pointer w-full mb-4"><FcGoogle/><h1 className="text-sm font-medium">Sign In With Google</h1></button>
        <p className="text-xs">
